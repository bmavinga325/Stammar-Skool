...
public class Doctor extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    String url = "PLD0JyJe60FTAcR8iHthaQgbGUskZxOZhI"; //Playlist code from url
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkPermission()) {
                    ...
                    Toast.makeText(Doctor.this, "Recording started.....", Toast.LENGTH_LONG).show();
                } else {
                    requestPermission();
                }
            }
        ...
        stopBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Doctor.this, "Recording Stopped", Toast.LENGTH_LONG).show();
            }
        });
        ...
        playBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) throws IllegalArgumentException,
                ...
                mediaPlayer.start();
                Toast.makeText(Doctor.this, "Recording is Playing.....", Toast.LENGTH_LONG).show();
            }
        });
...
//            youTubePlayer.loadVideo(url);
    ...
    private void requestPermission() {
        ...
        ActivityCompat.requestPermissions(Doctor.this, new
            ...
            case RequestPermissionCode:
                if (grantResults.length > 0) {
                    ...
                    if (StoragePermission && RecordPermission) {
                        Toast.makeText(Doctor.this, "Permission Granted",
                                Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(Doctor.this, "Permission Denied", Toast.LENGTH_LONG).show();
                    }
                }
                break;
        }
    ...
    public boolean checkPermission() {
        int result = ContextCompat.checkSelfPermission(Doctor.this,
                WRITE_EXTERNAL_STORAGE);
        int result1 = ContextCompat.checkSelfPermission(Doctor.this,
                RECORD_AUDIO);
