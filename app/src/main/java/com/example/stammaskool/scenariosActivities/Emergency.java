...
public class Emergency extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    String url = "PLD0JyJe60FTCKPzKz-_Gi7PPMB02gkxkt"; //Playlist code from url
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkPermission()) {
                    ...
                    Toast.makeText(Emergency.this, "Recording started.....", Toast.LENGTH_LONG).show();
                } else {
                    requestPermission();
                }
            }
        ...
        stopBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Emergency.this, "Recording Stopped", Toast.LENGTH_LONG).show();
            }
        });
        ...
        playBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) throws IllegalArgumentException,
                ...
                mediaPlayer.start();
                Toast.makeText(Emergency.this, "Recording is Playing.....", Toast.LENGTH_LONG).show();
            }
        });
...
//            youTubePlayer.loadVideo(url);
    ...
    private void requestPermission() {
        ...
        ActivityCompat.requestPermissions(Emergency.this, new
            ...
            case RequestPermissionCode:
                if (grantResults.length > 0) {
                    ...
                    if (StoragePermission && RecordPermission) {
                        Toast.makeText(Emergency.this, "Permission Granted",
                                Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(Emergency.this, "Permission Denied", Toast.LENGTH_LONG).show();
                    }
                }
                break;
        }
    ...
    public boolean checkPermission() {
        int result = ContextCompat.checkSelfPermission(Emergency.this,
                WRITE_EXTERNAL_STORAGE);
        int result1 = ContextCompat.checkSelfPermission(Emergency.this,
                RECORD_AUDIO);
