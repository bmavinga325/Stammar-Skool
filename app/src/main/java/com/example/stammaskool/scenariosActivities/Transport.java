...
public class Transport extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    String url = "PLD0JyJe60FTAjHCuJyXo_K3HQ-v2lmQr8"; //Playlist code from url
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkPermission()) {
                    ...
                    Toast.makeText(Transport.this, "Recording started.....", Toast.LENGTH_LONG).show();
                } else {
                    requestPermission();
                }
            }
        ...
        stopBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Transport.this, "Recording Stopped", Toast.LENGTH_LONG).show();
            }
        });
        ...
        playBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) throws IllegalArgumentException,
                ...
                mediaPlayer.start();
                Toast.makeText(Transport.this, "Recording is Playing.....", Toast.LENGTH_LONG).show();
            }
        });
...
//            youTubePlayer.loadVideo(url);
    ...
    private void requestPermission() {
        ...
        ActivityCompat.requestPermissions(Transport.this, new
            ...
            case RequestPermissionCode:
                if (grantResults.length > 0) {
                    ...
                    if (StoragePermission && RecordPermission) {
                        Toast.makeText(Transport.this, "Permission Granted",
                                Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(Transport.this, "Permission Denied", Toast.LENGTH_LONG).show();
                    }
                }
                break;
        }
    ...
    public boolean checkPermission() {
        int result = ContextCompat.checkSelfPermission(Transport.this,
                WRITE_EXTERNAL_STORAGE);
        int result1 = ContextCompat.checkSelfPermission(Transport.this,
                RECORD_AUDIO);
